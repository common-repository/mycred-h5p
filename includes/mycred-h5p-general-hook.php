...
<div class="hook-instance">
	<div class="row">
		...
		<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo esc_attr($this->field_id( 'percentage' )); ?>"><?php esc_html_e( 'Required Percentage', 'mycred' ); ?></label>
				<input type="text" name="<?php echo esc_attr($this->field_name( 'percentage' )); ?>" id="<?php echo esc_attr($this->field_id( 'percentage' )); ?>" value="<?php echo esc_attr($this->core->number( $prefs['percentage'] )); ?>" class="form-control" />
